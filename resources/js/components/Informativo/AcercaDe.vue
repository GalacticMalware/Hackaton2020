...
<br />
  ...
  <v-timeline>
    ...
    >
      ...
      <center>
        <v-card-title class="headline">¿Qué es SURE?</v-card-title>
        </center>
        <v-card-text>
        <center>
    ...
    >
      ...
      <v-card class="elevation-2">
      <center>
        <v-card-title class="headline">Características de la Solución</v-card-title>
        </center>
        <v-card-text>
        <center>
    ...
    >
      ...
      <v-card class="elevation-2">
      <center>
        <v-card-title class="headline">¿Cómo esta solución resuelve el problema que detectaste?</v-card-title>
        </center>
        <v-card-text>
          <center>
  ...
  <v-timeline-item
    ...
    >
      ...
      <v-card class="elevation-2">
      <center>
        <v-card-title class="headline">¿Cómo podrías empezar con la implementación en menos de 6 meses?</v-card-title>
        </center>
        <v-card-text>
        <center>
    ...
    >
      ...
      <v-card class="elevation-2">
      <center>
        <v-card-title class="headline">Cuáles son los cambios que esto generaría en las niñas y mujeres durante y post COVID-19?
<br />¿Cómo esto contribuye a la agenda de género en México?
